...
% Dm = Ibwater & roiPatchArray(1,2).patchMask; %second ROI mask in for DM - set pixels outside to zero

GfpStats = regionprops(Ibwater, Ig, 'MeanIntensity');
Gfp.total = [GfpStats.MeanIntensity];
