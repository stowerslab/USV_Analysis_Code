function [numCellsTotal, numGfpCellsTotal, numGfpCellsInDm, numGfpCellsInVl, numTdtCellsTotal, numTdtCellsInDm, numTdtCellsInVl, percentGfpCellsOfTotal, percentTdtOfGfpTotal, percentTdtOfGfpDm, percentTdtOfGfpVl ] = vmhCountCells( Gfp, Tdt, numCells, gfpThresh, tdtThresh )
%vmhCountCells: function to count cells and return percentages in different fluo channels & regions

% TO DO: make thresh inputs optional, compute here

numCellsTotal = numCells.total;
