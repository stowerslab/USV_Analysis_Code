...
% wavPath = 'E:\Jingyi\Dropbox (Scripps Research)\Jingyi Data backup\Behavior analysis\2019-8 WT SMUF for USV paper\T1\4 mins cut wav files\';
wavPath = 'E:\Jingyi\Dropbox (Scripps Research)\Jingyi Data backup\Behavior data\CHR2 experiment\2019-10 PAG vGat ChR2\10s light stimulation all\25hz 20s\';
...
stat8 = 'numUsvs0to10'; % 
stat9 = 'numUsvs10to20'; %   
stat10 = 'numUsvs20to30'; % 
stat11 = 'numUsvs30to40'; % 
...
numUsvs0to10(j)= length ( find (locUsvs<7500));
numUsvs10to20(j)= length ( find (locUsvs<15000 & locUsvs >=7500));
numUsvs20to30(j)= length ( find (locUsvs<22500 & locUsvs >=15000));
numUsvs30to40(j)= length ( find (locUsvs<30000 & locUsvs >=22500));
numUsvs40to50(j)= length ( find (locUsvs<37500 & locUsvs >=30000));
...
USVStats.numUsvs0to10= numUsvs0to10;
USVStats.numUsvs10to20= numUsvs10to20;
USVStats.numUsvs20to30= numUsvs20to30;
USVStats.numUsvs30to40= numUsvs30to40;
USVStats.numUsvs40to50= numUsvs40to50;
...
patch(x, y, [0 0.4 1], 'FaceAlpha', 0.3, 'EdgeColor', 'none'); % blue box
