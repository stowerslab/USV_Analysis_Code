...
wavPath =  '\\172.29.164.29\Jingyi Chen\Dropbox\Jingyi Data backup\GCaMP Analysis\2018-9 GCaMP BNST BATCH2\BG6\';

fontSz = 20;
mouseNums = {'BG6_T7L'};
totalMice = size(mouseNums, 2); 
plotSeparate = 1;
USVSamplerate=192000;
gcampFrameRate= 20;
...
ylim([-4 12]);
plot(timescaleGcamp, sig_norm, 'Color', cmapGcamp, 'LineWidth', 1);
ylim([-4 12]);
xlim([0,totalGCampSec]);
% axis tight;
hold off;
