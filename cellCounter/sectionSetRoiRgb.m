function [roiPatchArray, xMin, xMax, yMin, yMax] = sectionSetRoiRgb(IchooseRoi)
% sectionSetRoi2chan: function to read image and pick ROIs and set thresholds in order to quantify fluorescence
...
figure; hIm = imshow(IchooseRoi); %create image handle and show image
